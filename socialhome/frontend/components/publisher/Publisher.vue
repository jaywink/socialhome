    ...
    <b-form @submit.stop.prevent="onPostForm">
      <b-row>
        <b-col v-if="!isReply">
          ...
          <b-form-group v-show="model.visibility === visibilityOptions.LIMITED.value" label-for="include-following">
            <template slot="label">{{ translations.includeFollowing }}<br>
              <b-form-checkbox id="include-following" v-model="model.includeFollowing" name="include_following" />
              <b-form-text>
        ...
        <b-col>
          <template v-if="!isReply">
            <b-form-group label-for="pinned">
              <template slot="label">{{ translations.pinned }}<br>
                <b-form-checkbox id="pinned" v-model="model.pinned" name="pinned" />
                <b-form-text>
            ...
            <b-form-group label-for="federate">
              <template slot="label">{{ translations.federate }}<br>
                <b-form-checkbox id="federate" v-model="model.federate" name="federate" />
                <b-form-text>
          ...
          <b-form-group label-for="show-preview">
            <template slot="label">{{ translations.showPreview }}<br>
              <b-form-checkbox id="show-preview" v-model="model.showPreview" name="show_preview" />
              <b-form-text>
      ...
      <b-button class="w-100 pointer" type="submit" variant="primary">{{ "Save" | gettext }}</b-button>
    </b-form>
  </div>
</template>
