<template>
  <div class="socialhome-markdown-editor" :class="{fullscreen: fullscreen}">
    <textarea v-show="false" ref="easymde"></textarea>
    ...
    <b-progress v-show="isUploading" :value="uploadedSize" show-progress animated></b-progress>

    <div class="editor-toolbar-dropdown editor-toolbar-heading-dropdown" v-show="showDropdowns.headings">
      <ul>
        <li>
    ...
    >
      <ul>
        <li>
          <b-button
            block @click.stop.prevent="embeddPictureLink"
            :title="translations.insertImage"
          >{{ "Embedd link" | gettext }}
          </b-button>
        </li>
        <li>
...
export default {
    ...
    mounted() {
        ...
        try { //
            ...
            let node1 = this.$el.querySelectorAll(".heading-dropdown-button")[0]
            let popper1 = this.$el.querySelectorAll(".editor-toolbar-heading-dropdown")[0]
            ...
            if (this.uploadPicture !== undefined) {
                let node2 = this.$el.querySelectorAll(".picture-dropdown-button")[0]
                let popper2 = this.$el.querySelectorAll(".editor-toolbar-picture-dropdown")[0]
