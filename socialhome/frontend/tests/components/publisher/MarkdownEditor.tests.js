...
import MarkdownEditor from "frontend/components/publisher/MarkdownEditor"
...
describe("MarkdownEditor", () => {
    ...
    describe("processImages", () => {
        const images = [
            new File(new Array(88659).fill(0b0), "01e25466-0a55-4f7d-951d-aefec9a22d4b", {type: "image/jpg"}),
            new File(new Array(88654).fill(0b0), "f3bdeb4b-1a04-43c3-89b6-78e2c2c24a2e", {type: "image/jpg"}),
            new File(new Array(5699).fill(0b0), "9fcd33e0-b2c0-4548-b59d-3a79651209d4", {type: "image/jpg"}),
        ]
        ...
        it("should remove the images from uploadings when HTTP request has succeded of failed", (done) => {
            Vue.prototype.$http.post
                ...
                .onThirdCall().returns(Promise.reject(new DOMException()))
            ...
            Promise.all(target.processImages(images)).finally(() => {
                ...
                target.$delete.firstCall.should.have.been.calledWithExactly(target.images.uploading, "01e25466-0a55-4f7d-951d-aefec9a22d4b")
                target.$delete.secondCall.should.have.been.calledWithExactly(target.images.uploading, "f3bdeb4b-1a04-43c3-89b6-78e2c2c24a2e")
                target.$delete.thirdCall.should.have.been.calledWithExactly(target.images.uploading, "9fcd33e0-b2c0-4548-b59d-3a79651209d4")
                done()
            }).catch(done)
        })
